      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="glass-card shadow-xl border-0 p-6 mb-6">
          <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
            ...
            Quick Access to Consultations & Documents
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-xs text-gray-600 text-left">
                Diabetes • Hypertension • Long-term monitoring
              </span>
            </Button>
            ...
            <Button 
              ...
              onClick={() => window.location.href = '/medical-documents-linked'}
            >
              <div className="flex items-center gap-2 w-full">
              ...
              <span className="text-xs text-gray-600 text-left">
                Linked to patient • Auto-detect • Save to record
              </span>
            </Button>
          </div>
        </Card>

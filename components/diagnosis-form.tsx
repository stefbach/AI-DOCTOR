...
export default function DiagnosisForm({
  ...
  // NEW: State for tracking which GPT-5 model is used
  const [aiModel, setAiModel] = useState<string>('gpt-5-turbo')
  ...
  const calculateComplexityScore = () => {
    const symptomsCount = clinicalData?.symptoms?.length || 0
    const questionsCount = questionsData?.responses?.length || 0
    const medicalHistoryCount = patientData?.medicalHistory?.length || 0
    const medicationsCount = patientData?.currentMedications?.length || 0
    
    return symptomsCount + questionsCount + 
           (medicalHistoryCount > 3 ? 3 : 0) + 
           (medicationsCount > 3 ? 3 : 0)
  }
      ...
      try {
        ...
        if (currentConsultationId) {
          ...
          if (savedData?.diagnosisData) {
            ...
            if (savedData.diagnosisData.aiModel) {
              setAiModel(savedData.diagnosisData.aiModel)
            }
          }
        }
      } catch (error) {
  ...
  // Effect for realistic progression with GPT-5 messages
  useEffect(() => {
    if (loading) {
      ...
      const messages = [
        ...
        { time: 2000, msg: "Analyzing symptoms with enhanced AI...", progress: 15 },
        { time: 5000, msg: "GPT-5 identifying clinical syndrome...", progress: 25 },
        { time: 10000, msg: "Formulating diagnostic hypotheses with GPT-5...", progress: 40 },
        { time: 20000, msg: "Developing investigation strategy...", progress: 60 },
        { time: 30000, msg: "GPT-5 generating personalized treatment plan...", progress: 75 },
        { time: 40000, msg: "Adapting to Mauritian healthcare context (metric system)...", progress: 85 },
  ...
  useEffect(() => {
    ...
    saveData()
  }, [diagnosis, diagnosticReasoning, expertAnalysis, mauritianDocuments, documentsGenerated, aiModel])
  ...
  const animateProgressiveAppearance = (data: any) => {
    ...
    if (data.metadata?.ai_model) {
      setAiModel(data.metadata.ai_model)
    }
  ...
  const generateCompleteDiagnosisAndDocuments = async () => {
    ...
    const selectedModel = complexityScore >= 5 ? 'gpt-5' : 'gpt-5-turbo'
    ...
    console.log('🤖 Model selection:', {
      ...
      factors: { 
        ...
        questionsCount: questionsData?.responses?.length || 0,
        medicalHistoryCount: patientData?.medicalHistory?.length || 0,
        medicationsCount: patientData?.currentMedications?.length || 0
      }
    })
    ...
    try {
      ...
      const requestBody = {
        ...
        language,
        // Optional: can force a specific model
        // modelChoice: 'full' // or 'turbo'
      }
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-4 gap-3 mb-6">
              ...
              <div className="text-center p-3 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-xs font-medium text-gray-700">Mauritius (°C)</p>
              </div>
              <div className="text-center p-3 bg-white rounded-lg shadow-sm">
              ...
              <div className="text-center p-3 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-xs font-medium text-gray-700">Enhanced AI</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-4 rounded-lg">
              <div className="space-y-2">
                ...
                <ProgressStep completed={analysisProgress > 85} active={analysisProgress > 75 && analysisProgress <= 85}>
                  Adapting to Mauritian context (°C)
                </ProgressStep>
              </div>
            </div>
            ...
            <div className="flex justify-center mt-4">
              <Badge className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-4 py-1">
                Using {aiModel === 'gpt-5' ? 'GPT-5 Full' : 'GPT-5 Turbo'}
              </Badge>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <ul className="list-disc list-inside text-left max-w-md mx-auto">
                  ...
                  <li>OpenAI API key is configured for GPT-5</li>
  ...
  if (!diagnosis) {
    const complexityScore = calculateComplexityScore()
    const expectedModel = complexityScore >= 5 ? 'gpt-5' : 'gpt-5-turbo'
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg text-left max-w-md mx-auto">
                ...
                <div className="mt-3 pt-3 border-t border-gray-200">
                  <p className="text-xs font-semibold text-gray-700 mb-1">Case Complexity:</p>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Score: {complexityScore} - Will use {expectedModel}
                  </p>
                </div>
              </div>
        ...
        <CardHeader className="text-center">
          ...
          <div className="flex justify-center gap-4 mt-4">
            ...
            <Badge className="bg-gradient-to-r from-purple-500 to-blue-500 text-white">
              {aiModel === 'gpt-5' ? 'GPT-5 Full' : 
               aiModel === 'fallback' ? 'Fallback Mode' : 'GPT-5 Turbo'}
            </Badge>
            {documentsGenerated && (
          ...
          <div className="mt-2 flex items-center justify-center gap-2 text-sm text-gray-600">
            ...
            <span>Using metric system (°C) for Mauritius</span>
          </div>
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 border-blue-200">
            <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-t-lg">
              ...
              <div className="mt-2 flex items-center justify-center gap-2 text-sm text-white/90">
                ...
                <span>Generated with {aiModel === 'gpt-5' ? 'GPT-5 (Full Model)' : 'GPT-5 Turbo (Fast Model)'}</span>
                <span className="text-xs text-white/70">• Metric system (°C)</span>
              </div>
            </CardHeader>
            <CardContent className="p-8">
      ...
      <div className="flex justify-center">
        <div className="flex items-center gap-2 px-4 py-2 bg-white/70 rounded-full shadow-md">
          ...
          <span className="text-sm text-gray-600">
            Automatic generation with GPT-5 {aiModel === 'gpt-5' ? '(Full)' : aiModel === 'fallback' ? '(Fallback)' : '(Turbo)'}
          </span>
        </div>
      </div>
    </div>

...
export default function DiagnosisForm({
    ...
    const loadSavedData = async () => {
      ...
      try {
        ...
        if (currentConsultationId) {
          ...
          }, ['hasDiagnosisData', 'hasDiagnosis', 'hasDocuments'])
  ...
  useEffect(() => {
    debugLog('🎯 AUTO-GENERATION CHECK:', {
      hasAutoGenerated,
      hasDiagnosis: !!diagnosis,
      hasPatientData: !!patientData,
      hasClinicalData: !!clinicalData,
      hasChiefComplaint: !!clinicalData?.chiefComplaint
    }, ['hasAutoGenerated', 'hasDiagnosis', 'hasPatientData', 'hasClinicalData', 'hasChiefComplaint'])
    ...
    if (!hasAutoGenerated && 
      ...
      debugLog('🚀 AUTO-GENERATING DIAGNOSIS...')
      setHasAutoGenerated(true)
  ...
  useEffect(() => {
    const saveData = async () => {
      ...
      try {
        ...
        debugLog("💾 Auto-saved diagnosis data")
      } catch (error) {
  ...
  const animateProgressiveAppearance = (data: any) => {
    debugLog('🎭 Starting progressive appearance animation...')
  ...
  const generateCompleteDiagnosisAndDocuments = async () => {
    debugLog('🩺 ========== STARTING DIAGNOSIS GENERATION ==========')
    debugLog('📋 Patient Data:', {
      hasData: !!patientData,
      age: patientData?.age,
      sex: patientData?.sex
    }, ['hasData', 'age', 'sex'])
    debugLog('🏥 Clinical Data:', {
      ...
      hasChiefComplaint: !!clinicalData?.chiefComplaint
    }, ['hasData', 'symptomsCount', 'hasChiefComplaint'])
    ...
    try {
      debugLog("📡 Calling API /api/openai-diagnosis...")
      ...
      debugLog("📨 Response status:", { status: response.status }, ['status'])
      ...
      }, ['success', 'hasDiagnosis', 'hasDocuments'])

      if (data.success && data.diagnosis && data.mauritianDocuments) {
        debugLog("✅ Starting progressive display...")
        setLoading(false)
      ...
      debugLog("⚠️ Generating fallback data...")
      ...
      debugLog('🩺 ========== DIAGNOSIS GENERATION COMPLETE ==========')
    }
  }

  const forceRegenerate = () => {
    debugLog('🔄 Force regenerating diagnosis...')
  ...
  const generateCompleteFallback = () => {
    debugLog('🔧 Generating fallback diagnosis...')

...
export default function DiagnosisForm({
 ...
 const messages = [
 { time: 0, msg: "Connecting to GPT 5.2 Medical AI...", progress: 5 },
 ...
 GPT 5.2 Artificial Intelligence in Action
 </CardTitle>
 </CardHeader>
 ...
 <p className="text-xs font-medium text-gray-700">GPT 5.2</p>
 </div>
 <div className="text-center p-3 bg-white rounded-lg shadow-sm">

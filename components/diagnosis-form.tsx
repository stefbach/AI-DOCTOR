...
// Composant pour le texte qui apparaît progressivement
const StreamingText = ({ 
  text, 
  speed = 10,
  onComplete 
...
// Composant pour le statut de chaque section
...
// Composant helper pour les étapes de progression
...
export default function DiagnosisForm({
  ...
  // NOUVEAUX ÉTATS pour l'apparition progressive
  ...
  // États pour le statut de chaque section
        ...
        if (currentConsultationId) {
          ...
          if (savedData?.diagnosisData) {
            if (savedData.diagnosisData.diagnosis) {
              ...
              // Si on a des données sauvegardées, on affiche tout directement
  ...
  // Effect pour la progression réaliste
  useEffect(() => {
    if (loading) {
      ...
      const messages = [
        { time: 0, msg: "Connexion à l'IA médicale GPT-4o...", progress: 5 },
        { time: 2000, msg: "Analyse des symptômes et antécédents médicaux...", progress: 15 },
        ...
        { time: 30000, msg: "Génération du plan thérapeutique personnalisé...", progress: 75 },
        { time: 40000, msg: "Adaptation au contexte de santé mauricien...", progress: 85 },
  ...
  // Fonction pour animer l'apparition progressive des sections
  ...
  const generateCompleteDiagnosisAndDocuments = async () => {
    ...
    try {
      ...
      // Le loading est maintenant géré dans animateProgressiveAppearance
  ...
  // Main interface with diagnosis - AVEC ANIMATION PROGRESSIVE
  return (
    <div className="space-y-6">
      {/* Success header */}
      ...
      {/* Section navigation avec statuts */}
      ...
      {/* DIAGNOSTIC REASONING - Avec animation */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                  ...
                  <p className="text-sm text-gray-700">
                    <StreamingText text={diagnosticReasoning.key_findings?.red_flags || "Aucun signal d'alerte identifié"} speed={8} />
                  </p>
                </div>
              </div>
      ...
      {/* PRIMARY DIAGNOSIS - Avec animation */}
            ...
            <CardContent className="p-8 space-y-6">
              <div className="text-center p-6 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl border-2 border-emerald-200">
                <h3 className="text-2xl font-bold text-emerald-800 mb-4">
                  <StreamingText 
                    text={language === 'fr' && diagnosis?.primary?.condition_bilingual?.fr 
                ...
                <div>
                  ...
                  <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <StreamingText 
                        text={language === 'fr' && diagnosis.primary.detailedAnalysis_bilingual?.fr 
              ...
              {diagnosis?.primary?.clinicalRationale && (
                <div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <StreamingText 
                        text={language === 'fr' && diagnosis.primary.clinicalRationale_bilingual?.fr 
              ...
              {diagnosis?.primary?.prognosis && (
                <div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <StreamingText 
                        text={language === 'fr' && diagnosis.primary.prognosis_bilingual?.fr 
      ...
      {/* INVESTIGATION STRATEGY - Avec animation */}
      ...
      {/* DIFFERENTIAL DIAGNOSES - Avec animation */}

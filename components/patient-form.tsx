...
export default function ModernPatientForm({ onDataChange, onNext }: PatientFormProps) {
  const [formData, setFormData] = useState<PatientFormData>({
    ...
    otherMedicalHistory: "",
    currentMedicationsText: "Lisinopril 10mg - 1 fois le matin\nParacétamol 1g - si besoin",
    lifeHabits: {
      smoking: "Ex-fumeur",
      alcohol: "Occasionnel", 
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Autre identité de genre..."
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Décrivez toute autre allergie connue..."
                rows={3}
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Décrivez tout autre antécédent médical..."
                rows={3}

...
export default function PatientAdviceCarousel({
 ...
 <p className="text-sm font-medium text-gray-700">AI Analysis GPT-5.4</p>
 ...
 <p>These suggestions help you gather valuable clinical information while GPT-5.4 AI analyzes the case. The complete analysis will be available in approximately {Math.ceil((100 - analysisProgress) * 0.6)} seconds.</p>
 </div>
 </div>
 </div>
 </div>

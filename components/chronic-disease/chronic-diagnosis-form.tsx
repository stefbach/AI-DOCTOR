    ...
    <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {detailedMealPlan.portionControlTips?.length > 0 && (
                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3">
                  <Label className="text-sm font-semibold text-indigo-900 mb-2">Portion Control Tips:</Label>
                  <ul className="text-xs text-gray-700 space-y-1">
                  ...
                  {followUpPlan.specialistConsultations.map((consultation: any, idx: number) => (
                    <div key={idx} className="bg-indigo-50 border border-indigo-200 rounded-lg p-3">
                      <div className="flex justify-between items-start mb-1">
                        <Label className="font-semibold text-indigo-900">{consultation.specialty}</Label>
                        <Badge className="bg-indigo-600 text-white text-xs">{consultation.frequency}</Badge>
                      </div>
      ...
      <div className="flex justify-between pt-6 border-t-2">
        ...
        <Button 
          ...
          size="lg"
          className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-base px-8"
        >
